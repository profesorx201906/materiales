    ...
    <div class="form-container">
        ...
        <form action="{{ route('colaboradores.update', $colaborador) }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" id="nombre" name="nombre" value="{{ old('nombre', $colaborador->nombre) }}" required>
                @error('nombre')
            ...
            <div class="form-group">
                ...
                <input type="text" id="numero_identificacion" name="numero_identificacion" value="{{ old('numero_identificacion', $colaborador->numero_identificacion) }}" required>
            ...
            <div class="form-group">
                ...
                <input type="number" id="valor_maximo_dinero" name="valor_maximo_dinero" step="0.01" value="{{ old('valor_maximo_dinero', $colaborador->valor_maximo_dinero) }}" required>
            ...
            <div class="form-group">
                ...
                <select id="categoria_id" name="categoria_id" required>
                    ...
                    @foreach ($categorias as $categoria)
                        <option value="{{ $categoria->id }}" {{ old('categoria_id', $colaborador->categoria_id) == $categoria->id ? 'selected' : '' }}>
                            {{ $categoria->nombre }}
                        </option>
                    @endforeach
                </select>
